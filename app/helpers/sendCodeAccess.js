...
const sendCodeAccess = async (data) => {
  const msg = {
    ...
    html: `
            ...
            <h5>Você não precisa decorar essa senha, ela estará disponível pra você aqui neste email e na nossa <strong><h4><a href='http://localhost:3000' target="_blank">PLATAFORMA</a></h4></strong></h5>
